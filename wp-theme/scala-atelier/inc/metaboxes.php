		...
		'scala_type' => array(
			...
			'fields' => array(
				array(
					...
					'help'  => __( 'Порожньо — береться назва запису. Назву тримаємо короткою (вона йде в меню, картки й підвал), а сюди пишемо повну фразу із запитом: «Римські штори на замовлення в Києві».', 'scala' ),
				),
				array(
					'key'     => 'tag',
					'type'    => 'text',
