...
function scala_seed_options( array $img ): void {
	...
	$values['places'] = array(
		array( 'text' => 'Квартира' ),
		array( 'text' => 'Будинок' ),
		array( 'text' => 'Комерційне приміщення' ),
	);
...
function scala_seed_reviews(): void {
	...
	scala_seed_post(
		'scala_review',
		'Повне оформлення вікон у будинку',
		array(
			'order'   => 1,
			'content' => '«Хочу ще раз подякувати за повне оформлення вікон в нашому будинку. Жінка приїхала, переживала, що не сподобається, але була у захваті. Окремо хочу подякувати за якість цих тканин — справді відчувається, що вони прослужать нам довго.»',
			'meta'    => array( 'author' => 'Клієнт · повне оформлення вікон у будинку' ),
		)
	);
}
